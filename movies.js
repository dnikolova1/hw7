firebase.auth().onAuthStateChanged(async function(user) {
    if (user) {
     // signed in
        ...
        let userId = user.uid
        let apiKey = '565907b044d0978437c3b4b0b5625b6d'
        ...
        document.querySelector('.sign-in-or-sign-out').innerHTML = `
            <class="text-white-500 text-center">Signed in as ${userName} </>    
            <button class="text-pink-500 underline text-right sign-out">Sign Out</button>
            `
